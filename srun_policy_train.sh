...
#SBATCH -J img_nav_policy
#SBATCH -o train_policy_logs/img_nav_policy.out
#SBATCH -e train_policy_logs/img_nav_policy.err
...
set -x
python -m torch.distributed.launch --nproc_per_node=4 --use_env rl-distance-train/train_image_nav.py --dist-to-goal
